function processRestaurantManagerCommands(commands) {
    ...
    var RestaurantEngine = (function () {
        ...
        var Restaurant = (function () {
            ...
            var formatRecipesOutput = function() {
                var drinks,
                    salads,
                    mainCourses,
                    desserts,
                ...
                drinks = getRecipeByType.call(this, Drink);
                salads = getRecipeByType.call(this, Salad);
                mainCourses = getRecipeByType.call(this, MainCourse);
                desserts = getRecipeByType.call(this, Dessert);
            ...
            Restaurant.prototype.printRestaurantMenu = function(){
                var result = '';
                result += ('***** ' + this._name + ' - ' + this._location + ' *****' + '\n');

                if(_recipes.length <= 0){
                    result += 'No recipes... yet' + '\n';
                } else {
                    result += formatRecipesOutput.call(this);
                }
        ...
        var Recipe = (function () {
            ...
            Recipe.prototype.toString = function() {
                ...
                result += '== ' + this._name + ' == $' + this._price.toFixed(2) + '\n' +
        ...
        var Meal = (function () {
            ...
            Meal.prototype.toString = function () {
                ...
                result += vegan + Recipe.prototype.toString.call(this) + '\n';
            };
        ...
        var Dessert = (function () {
            function Dessert(name, price, calories, quantity, timeToPrepare, isVegan, withSugar) {
                ...
                this._withSugar = withSugar || true;
            }
            ...
            Dessert.prototype.toString = function() {
                var result = '',
                    containsSugar = this._withSugar ? '' : '[NO SUGAR] ';

                result += containsSugar + Meal.prototype.toString.call(this);
            };
        ...
        var MainCourse = (function () {
            ...
            MainCourse.prototype.toString = function () {
                ...
                result += Meal.prototype.toString.call(this) + 'Type: ' + this._type;
            };
        ...
        var Salad = (function() {
            ...
            Salad.prototype.toString = function(){
                var result = '',
                    containsPasta = this._containsPasta ? 'yes' : 'no';

                result += Meal.prototype.toString.call(this) + containsPasta;
                return result;
            };
